...
TEST_CASE("test_cdf", "[cdf]"){
    ...
    PPF<float> test_cdf2_ppf = {0, .25, .25, .25, .25, .25, .25, .50, .50, .50, .50, .50, .50, .50,.50,.50,.50, .75, .75, .75};
    ...
    PPF<float> test_cdf3_ppf = {.2, .2, .2, .2, .2, .2, .2, .2, .2, .2, .3, .3, .3, .3, .3, .3, .3, .5, .6, .6};
    test_cdf3.get_ppf().print();
